...
(_a = document.getElementById('resumeForm')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (event) {
    ...
    if (profilePictureInput
        ...
        && skillsElement
        && usernameElement) {
        var firstname_1 = firstnameElement.value;
            ...
            shareLinkButton.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            shareableLink = "https://yourdomain.com/resumes/".concat(firstname_1.replace(/\s+/g, "_"), "_cv.html");
